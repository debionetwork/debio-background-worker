module.exports = async () => {
  ...
  const substrateFixture = require('./substrate-fixture.listener'); // eslint-disable-line
  const elasticsearchFixture = require('./elasticsearch-fixture.listener'); // eslint-disable-line
