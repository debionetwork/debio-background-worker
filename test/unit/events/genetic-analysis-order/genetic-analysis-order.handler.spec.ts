...
import { GeneticAnalysisOrderCancelledCommand, GeneticAnalysisOrderCommandHandlers, GeneticAnalysisOrderCreatedCommand, GeneticAnalysisOrderFailedCommand, GeneticAnalysisOrderFulfilledCommand, GeneticAnalysisOrderPaidCommand, GeneticAnalysisOrderRefundedCommand } from "../../../../src/substrate/events/genetic-analysis-order";
...
describe('Genetic Analysis Order Substrate Event Handler', () => {
  ...
  beforeEach(async () => {
    ...
    geneticAnalysisOrderCancelledHandler = modules.get(GeneticAnalysisOrderCancelledHandler);
    geneticAnalysisOrderCreatedHandler = modules.get(GeneticAnalysisOrderCreatedHandler);
    geneticAnalysisOrderFailedHandler = modules.get(GeneticAnalysisOrderFailedHandler);
    geneticAnalysisOrderFulfilledHandler = modules.get(GeneticAnalysisOrderFulfilledHandler);
    geneticAnalysisOrderPaidHandler = modules.get(GeneticAnalysisOrderPaidHandler);
    geneticAnalysisOrderRefundedHandler = modules.get(GeneticAnalysisOrderRefundedHandler);
  ...
  describe('Genetic Analysis Order Cancelled Handler', () => {
    ...
    it('should update genetic analysis order status to cancelled', async() => {
      ...
      const geneticAnalysisOrderCancelledCommand: GeneticAnalysisOrderCancelledCommand = 
        new GeneticAnalysisOrderCancelledCommand([GENETIC_ANALYSIS_ORDER_PARAM], mockBlockNumber());

      await geneticAnalysisOrderCancelledHandler.execute(geneticAnalysisOrderCancelledCommand);
  ...
  describe('Genetic Analysis Order Created Handler', () => {
    ...
    it('should create index genetic analysis order', async() => {
      ...
      const geneticAnalysisOrderCreatedCommand: GeneticAnalysisOrderCreatedCommand = 
        new GeneticAnalysisOrderCreatedCommand([GENETIC_ANALYSIS_ORDER_PARAM], mockBlockNumber());

      await geneticAnalysisOrderCreatedHandler.execute(geneticAnalysisOrderCreatedCommand);
  ...
  describe('Genetic Analysis Order Failed Handler', () => {
    ...
    it('should update genetic analysis order status to failed', async() => {
      ...
      const geneticAnalysisOrderFailedCommand: GeneticAnalysisOrderFailedCommand = 
        new GeneticAnalysisOrderFailedCommand([GENETIC_ANALYSIS_ORDER_PARAM], mockBlockNumber());

      await geneticAnalysisOrderFailedHandler.execute(geneticAnalysisOrderFailedCommand);
  ...
  describe('Genetic Analysis Order Fulfilled Handler', () => {
    ...
    it('should update genetic analysis order status fulfilled', async() => {
      ...
      const geneticAnalysisOrderFulfilledCommand: GeneticAnalysisOrderFulfilledCommand = 
        new GeneticAnalysisOrderFulfilledCommand([GENETIC_ANALYSIS_ORDER_PARAM], mockBlockNumber());
  ...
  describe('Genetic Analysis Order Paid Handler', () => {
    ...
    it('should update genetic analysis order status paid', async() => {
      ...
      const geneticAnalysisOrderPaidCommand: GeneticAnalysisOrderPaidCommand = 
        new GeneticAnalysisOrderPaidCommand([GENETIC_ANALYSIS_ORDER_PARAM], mockBlockNumber());

      await geneticAnalysisOrderPaidHandler.execute(geneticAnalysisOrderPaidCommand);
  ...
  describe('Genetic Analysis Order Refunded Handler', () => {
    ...
    it('should update genetic analysis order status refunded', async() => {
      ...
      const geneticAnalysisOrderRefundedCommand: GeneticAnalysisOrderRefundedCommand = 
        new GeneticAnalysisOrderRefundedCommand([GENETIC_ANALYSIS_ORDER_PARAM], mockBlockNumber());
