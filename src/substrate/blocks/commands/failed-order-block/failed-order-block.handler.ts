...
import { FailedOrderBlockCommand } from './failed-order-block.command';

@Injectable()
@CommandHandler(FailedOrderBlockCommand)
export class FailedOrderBlockHandler
  implements ICommandHandler<FailedOrderBlockCommand>
{
  constructor(private readonly elasticsearchService: ElasticsearchService) {}

  async execute(command: FailedOrderBlockCommand) {
